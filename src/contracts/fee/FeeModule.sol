...
import {IPortfolio} from "src/contracts/core/interfaces/IPortfolio.sol"; //@note supports the added function
...
contract FeeModule is FeeConfig, FeeCalculations {
    ...
    //@note only place where code was added for the poc, as the circular dependency arose between Portfolio.sol and FeeModule.sol
